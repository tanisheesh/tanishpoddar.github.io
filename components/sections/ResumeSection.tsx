...
const ResumeSection = forwardRef<HTMLElement, ResumeSectionProps>((props, ref) => {
  ...
  return (
    <section ref={ref} id="resume" className="min-h-screen flex items-center justify-center py-8 md:py-12 px-4">
          ...
          >
            <div className="flex flex-col md:flex-row items-center justify-between mb-6">
              <div className="flex items-center mb-4 md:mb-0">
                ...
                <div>
                  <h3 className="text-xl font-semibold">Tanish Poddar-Resume.pdf</h3>
                  <p className="text-sm text-gray-400">Updated: February 2026</p>
                </div>
              </div>
              <a 
                href="/documents/Tanish%20Poddar-Resume.pdf" 
                download="Tanish-Poddar-Resume.pdf"
            ...
            <div className="aspect-[3/4] bg-gray-900 rounded-md border border-gray-700 overflow-hidden relative">
              <iframe
                src="/documents/Tanish%20Poddar-Resume.pdf#toolbar=0&navpanes=0&scrollbar=0&view=FitH"
